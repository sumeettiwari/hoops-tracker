...
export default function App() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0a0c0f", color: "#e8e4d9", fontFamily: "'Bebas Neue', sans-serif", position: "relative", width: "100%" }}>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        html, body { background: #0a0c0f; width: 100%; }
        #root { width: 100%; }
        .centered { max-width: 960px; margin-left: auto; margin-right: auto; padding-left: 16px; padding-right: 16px; width: 100%; }
  ...
  return (
    <div style={{ minWidth: 720 }}>
      <div style={{ padding: "12px 16px", borderBottom: "1px solid #1e2128", fontFamily: "'Bebas Neue'", fontSize: 11, letterSpacing: 3, display: "grid", gridTemplateColumns: cols, textAlign: "right" }}>
        ...
        <span style={{ textAlign: "left", paddingLeft: 10 }}><ColHeader col="winpct" label="W-L" color="#22c55e" /></span>
        <ColHeader col="winpct" label="WIN%" color="#22c55e" />
      </div>
      {players.map((p, i) => {
        ...
        return (
          <div key={p.id} style={{ padding: "11px 16px", borderBottom: "1px solid #0f1115", background: i === 0 && !dim ? "rgba(249,115,22,0.04)" : i % 2 === 0 ? "rgba(255,255,255,0.02)" : "transparent", display: "grid", gridTemplateColumns: cols, textAlign: "right", fontFamily: "'DM Mono'", fontSize: 13 }}>
            ...
            <span style={{ color: !hasWL ? "#2a2d35" : "#e8e4d9", whiteSpace: "nowrap", textAlign: "left", paddingLeft: 10 }}>
